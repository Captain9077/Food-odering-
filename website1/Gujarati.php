    ...
    <div class="container-fluid mt-xl-5">
        <div class="row mt-4">
            <div class="col-12 mt-xl-5">
                <p class="fs-5">One of the best experiences of travelling to Gujarat is its multi-cuisine. There is an old saying that says dining in Surat is the way to heaven and this explains the bliss of exploring Gujarati cuisine! Gujarati cuisine is one of the oldest culinary treasures of India and is unique in many ways. Gujarat, known as the ‘Jewel of Western India’, is known for its wide variety of vegetarian dishes that are not only delicious but also high in nutritional value.</p>
            </div>
            <div class="col-12 mt-5">
                <h1>Experience the authentic Gujarati Thali</h1>
            </div>
            <div class="col-12 mt-3">
                <p class="fs-5">
                    We all know that the best way to experience a state and its culture is to explore its cuisine. The methods of cooking used in preparing the dishes, the spices and herbs used and the seasonal foods available in that part of the state contribute mainly to the flavour of the dishes prepared. If we want to have the ultimate experience of tasting the delectable Gujarati cuisine, savouring the Gujarati thali is the finest option. People who want to treat themselves to this delightful vegetarian fare can find the most authentic Gujarati thali nearby Vastrapur, Ahmedabad, at Food On Way. <br>
                    <br>
            ...
            <div class="col-8">
                <p class="fs-5 p-5">
                    Farsans- steamed or fried snacks; <br>
                    Shaak- the main course vegetable dish, mostly a tuber or a gourd, that can either be a curry or a spicy dry dish; <br>
                    kathol- pulses like beans or dry peas cooked by braising; <br>
                    Rice or khichdi; <br>
                    Bajra or wheat rotlis called bakhris, parathas or thepla; <br>
                    kadhi – a yoghurt dish with pulse soup; <br>
                    Raita or sweet shrikhand; <br>
                    Sweets like halwas, basundi or shrikhand.
                </p>
            </div>
            <div class="col-4">
                <img src="gm1.png" alt="" class="d-block pe-5" style="width:100%">
            </div>
            <div class="col-12">
                <p class="fs-5">
                    Sweets like halwas, basundi or shrikhand.
                    <br>
                    This exciting spread can be accompanied by a variety of sweet, sour and spicy chutneys, pickles, ghee and a salad of chopped vegetables served raw or steamed with spices. Started in Ahmedabad, with the aim of making life exciting for students and bachelors who want to savour Gujarati delicacies, Food On Way provides wholesome Gujarati food near Vastrapur and Prahlad Nagar. Quick delivery and convenient packing add value to our delicious Gujarati thali. <br>
                    <br>
            ...
            <div class="col-12 mt-4">
                <h1>A delectable array of dishes in Gujarati Thali, Ahmedabad</h1>
            </div>
            <div class="col-12 mt-3">
                <p class="fs-5">It is a well-known fact that the Gujarati thali has garnered much fame not just in India but also overseas. The authenticity of Gujarati foods is attributed to the distinct spices used and the unique cooking methods employed to bring on the desired fusion of flavours. In 2015, we started Food On Way with the vision of providing authentic Gujarati thali to our patrons in Ahmedabad. We started with two branches, one in Vastrapur and one in Prahlad Nagar, both specialising in delectable North Indian vegetarian fare.
                    <br>
            ...
            <div class="col-4 mt-3">
                <img src="gm2.png" alt="" class="d-block rounded" style="width:100%">
            </div>
            ...
            <div class="col-4 mt-4">
                <img src="gm3.png" alt="" class="d-block rounded" style="width:100%">
            </div>
            <p class="fs-5 mt-5 p-5">
                A choice of any two vegetable dishes, <br>
                Rotis/pooris, <br>
                Dal and rice, <br>
                Green salad, <br>
                Pickle <br>
            ...
            <div class="col-3">
                <img src="gm4.png" alt="" class="d-block rounded" style="width:100% height = 80%">
            </div>
            <div class="col-12">
                <p class="fs-5">
